...
public class UpdateChecker {
    ...
    public static UpdateChecker of(JavaPlugin javaPlugin) {
        return new UpdateChecker(javaPlugin);
    }

    public UpdateChecker currentVersion(String currentVersion) {
    ...
    public UpdateChecker handleResponse(BiConsumer<VersionResponse, String> versionResponse) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this.javaPlugin, () -> {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(
                        String.format(SPIGOT_URL, this.resourceId)).openConnection();
